...
<div class="container">
    ...
    <form action="{{ route('withdrawPercents.update',$withdrawPercent->id)}}" method="POST">
        @csrf
        @method('PUT')
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input type="number" name="admin_percent" class="form-control" placeholder="input Admin Fee (%)"
                            value="{{ $withdrawPercent->admin_percent }}" required>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input type="number" class="form-control" name="agent_percent" placeholder="input Agent Fee (%)"
                            value="{{ $withdrawPercent->agent_percent }}" required>
                        <span class="input-group-addon"> %</span>
                    </div>
